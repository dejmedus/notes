...
Whether the syntax looks like `print(2+4)`, `say 2 potato 4` or even `🖨2️⃣🤝4️⃣`, an _interpreted_ language will be broken down into something the _interpreter_, a program that executes code at runtime<sup><a href="#resources">1</a></sup>, understands
