...
```ruby
frogs_path # index /frogs
frog_path(1) # show /frogs/1
new_frog_path # new /frogs/new
edit_frog_path(1) # edit /frogs/1/edit
```
...
```bash
rails g migration AddColorIndexToFrogs color:string:index
