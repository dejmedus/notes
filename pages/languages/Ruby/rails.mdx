...
Rails is a bunch of gems working together 🫶

- **actioncable**: webSockets and real-time features (ex. chat, notifications)
- **actionmailbox**: mailboxes
- **actionmailer**: send emails
- **actionpack**: routing, controllers, and req/response
- **actiontext**: rich text editor
- **actionview**: templates, helpers, and form builders
- **activejob**: background jobs
- **activemodel**: validations, callbacks, and serialization
- **activerecord**: ORM, database queries, migrations, associations
- **activestorage**: file uploads to storage
- **activesupport**: core utilities and extensions (`blank?`, `present?`)
